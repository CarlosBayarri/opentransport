...
if __name__== '__main__':
    ...
    tabla='d.buildings'
    str_field_names='descripcion, geom' 
    list_field_values=['Random', 'POLYGON((727844 4373183,727896 4373187,727893 4373028,727873 4373018,727858 4372987,727796 4372988,727782 4373008,727844 4373183, 727844 4373183))']
    str_s_values= '%s,st_geometryfromtext(%s,25830)'
    insertFunc(nom_tabla=tabla, str_field_names=str_field_names, list_field_values=list_field_values, str_s_values2=str_s_values)
